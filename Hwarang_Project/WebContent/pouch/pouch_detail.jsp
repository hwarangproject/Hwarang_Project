				...
				<div class="col-xs-9">
					...
					<div class="mainmenu pull-left">
						<ul class="nav navbar-nav collapse navbar-collapse">
							<li><a href="../Hwarang/main.jsp" class="active">Home</a></li>
							<li class="dropdown"><a href="#">랭킹<i
									class="fa fa-angle-down"></i></a>
								<ul role="menu" class="sub-menu">
									<li><a href="shop.jsp">상품별</a></li>
									<li><a href="../Eshopper/product-details.html">연령별</a></li>
									<li><a href="../Eshopper/checkout.html">별점순</a></li>
							...
							<li class="dropdown"><a href="#">브랜드<i
									class="fa fa-angle-down"></i></a>
								<ul role="menu" class="sub-menu">
									<li><a href="../Eshopper/blog.html">미샤</a></li>
									<li><a href="../Eshopper/blog-single.html">이니스프리</a></li>
								</ul></li>
							<li><a href="#">게시판</a></li>
